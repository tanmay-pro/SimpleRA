...
vector<vector<int>> Cursor::getMatrixPage()
{
    logger.log("Cursor::getMatrixPage");
    return this->page.getMatrixPage();
}

vector<vector<int>> Cursor::getTablePage()
{
    logger.log("Cursor::getTablePage");
    return this->page.getTablePage();
}