...
void ParsedQuery::clear()
{
    ...
    this->groupByCheckColumn = "";
    this->groupByReturnColumn = "";
    this->groupByCheckColumnOperator = NO_GROUPBY_CLAUSE;
    this->groupByReturnColumnOperator = NO_GROUPBY_CLAUSE;
    this->groupByBinaryOperator = NO_BINOP_CLAUSE;
    this->groupByValueToCheck = 0;
}
